    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinics', models.ManyToManyField(related_name='doctors', to='clinics.clinic', verbose_name='Clinics')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('specializations', models.ManyToManyField(related_name='doctors', to='clinics.specialization', verbose_name='Specializations')),
